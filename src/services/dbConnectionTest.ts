...
export interface ReadTestResult extends TestResult {
  tableCount: number;
  tables: string[];
  error?: Error;
}

export interface WriteTestResult extends TestResult {
  comment?: string;
  commentId?: number | null;
  error?: Error;
}

export interface TablesCheckResult extends TestResult {
...
export interface AllTestResults {
  ...
  read: ReadTestResult;
  write: WriteTestResult;
  tables: TablesCheckResult;
}
 ...
 */
export async function testDatabaseWrite(): Promise<WriteTestResult> {
  try {
 ...
 */
export async function testDatabaseRead(): Promise<ReadTestResult> {
  try {
 ...
 */
export async function runAllConnectionTests(): Promise<AllTestResults> {
